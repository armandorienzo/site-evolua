...
import { CheckCircle, AlertCircle, User, Building, Phone, Mail, MapPin, Calendar, FileText, ArrowLeft, Shield, ExternalLink } from 'lucide-react'
import { Link } from 'react-router-dom'
import evoluaLogo from '../assets/evolua-logo.png'

function CadastroClientePage() {
  // Estado para o checklist de condições
  const [checklistItems, setChecklistItems] = useState([
    { id: 1, checked: false, text: 'Minha empresa está enquadrada no Simples Nacional.' },
    { id: 2, checked: false, text: 'Minha empresa não possui nenhum funcionário registrado e nenhum sócio recebe pró-labore.' },
    { id: 3, checked: false, text: 'Estou contratando um plano exclusivo para empresas sem folha de pagamento ativa (sem encargos trabalhistas ou previdenciários).' },
    { id: 4, checked: false, text: 'Minha empresa emite no máximo 3 notas fiscais por mês.' },
    { id: 5, checked: false, text: 'O faturamento mensal da empresa não ultrapassa R$ 30.000,00.' },
    { id: 6, checked: false, text: 'Estou ciente de que, caso minha empresa ultrapasse quaisquer dos limites acima, a mensalidade do plano será automaticamente reajustada de acordo com o novo porte e volume de movimentação, mediante aviso e novo enquadramento contratual.' }
  ])
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.sucesso) {
        ...
        window.open('https://www.asaas.com/c/le2lpecfamkd38n4', '_blank')
        ...
        <div className="max-w-4xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-900">Contratação Evolua</h1>
                <p className="text-sm text-gray-600">Plano exclusivo para empresas sem folha de pagamento</p>
              </div>
            </div>
            <Link to="/">
        ...
        {!showForm ? (
          ...
          <Card className="mb-6">
            <CardHeader>
              ...
              <CardDescription>
                Antes de contratar o plano, declaro estar ciente e de acordo com as condições abaixo:
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div className="flex justify-center">
                <Button 
                  ...
                  className="px-8 py-3 bg-green-600 hover:bg-green-700 text-white disabled:bg-gray-300 disabled:cursor-not-allowed"
                >
                  {allItemsChecked ? (
                    <>
                    ...
                    'Marque todas as condições para prosseguir'
                  )}
                </Button>
              </div>
              ...
              {!allItemsChecked && (
                <p className="text-sm text-gray-600 text-center mt-2">
                  É necessário concordar com todas as condições para contratar o plano.
                </p>
              )}
            </CardContent>
          </Card>
